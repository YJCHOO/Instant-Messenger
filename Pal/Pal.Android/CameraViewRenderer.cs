...
namespace Pal.Droid
{ 
    class CameraViewRenderer : PageRenderer ,TextureView.ISurfaceTextureListener
    {
        ...
        public void SetupEventHandlers()
        {
            capturePhotoButton.Click += async (sender, e) =>
            {
                ...
                (Element as CameraView).SetPhotoResult(bytes, liveView.Bitmap.Width, liveView.Bitmap.Height);
            };
